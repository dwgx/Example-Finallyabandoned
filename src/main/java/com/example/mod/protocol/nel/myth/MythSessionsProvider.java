package com.example.mod.protocol.nel.myth;
...
public class MythSessionsProvider implements GameSessionProvider {
    ...
    public void refresh() {
        try {
            MythResponse response = Http.get("http://127.0.0.1:" + ModuleProtocol.getInstance().getMythPort() + "/launcher/GetProxyServers")
